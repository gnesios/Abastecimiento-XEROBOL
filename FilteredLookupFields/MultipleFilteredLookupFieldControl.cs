            ...
            get
            {
                ...
                if (s != null && s.Count > 0)
                {
                    foreach (var i in s)
                    {
                        ...
                        {//Added by 3r1ck
                            foreach (SPFieldLookupValue _fieldValue in _fieldVals)
                            {
                                if (_fieldValue.LookupId == int.Parse(i.ToString()))
                                {
                                    _vals.Add(new SPFieldLookupValue(_fieldValue.LookupId, _fieldValue.LookupValue));
                                    break;
                                }
                            }
                        }
