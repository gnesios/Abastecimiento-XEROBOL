<%@ Assembly Name="FilteredLookupFields, Version=1.0.0.0, Culture=neutral, PublicKeyToken=cf45455818e88c85" %>
...
<%@ Control Language="C#" AutoEventWireup="true" Inherits="FilteredLookupFields.FilteredLookupFieldEditor" %>

<wssuc:InputFormSection runat="server" id="FilterLookupFieldSection" Title="Configuración de columna adicional (filtro)">
    <Template_InputFormControls>
        <wssuc:InputFormControl runat="server" LabelText="Especifique opciones detalladas para la columna de búsqueda filtrada.">
            <Template_Control>
                    ...
                    <table style="width: 100%; border-width: 0px; border-collapse: collapse;" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="ms-authoringcontrols" style="width: 100%; text-align: left; white-space: nowrap; padding-top: 10px;">
                          <span>Obtener información de sitio:</span>
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td class="ms-authoringcontrols" style="width: 100%; text-align: left; white-space: nowrap; padding-top: 10px;">
                          <span>Obtener información de:</span>
                        </td>
                      </tr>
                      <tr>
                        <td class="ms-authoringcontrols" style="width: 100%; text-align: left; white-space: nowrap;">
                      ...
                      <tr>
                        ...
                        <span style="padding-left: 0px;">
                          <asp:RadioButtonList CssClass="ms-authoringcontrols" RepeatLayout="Flow" RepeatDirection="Horizontal" runat="server" ID="rdFilterOption" OnSelectedIndexChanged="SelectedFilterOptionChanged" AutoPostBack="true">
                            <asp:ListItem Selected="True" Text="Aplicar filtro de consulta" Value="Query" />
                            <asp:ListItem Text="Aplicar filtro de vista" Value="ListView" />
                          </asp:RadioButtonList>
                         </span>
                        </td>
                      </tr>
